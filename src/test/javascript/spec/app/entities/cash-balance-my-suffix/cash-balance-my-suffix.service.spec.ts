...
describe('Service Tests', () => {
    ...
    describe('CashBalanceMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CashBalanceMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/cash-balances';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CashBalanceMySuffix', () => {
