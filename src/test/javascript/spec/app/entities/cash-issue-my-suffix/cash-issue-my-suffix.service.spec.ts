...
describe('Service Tests', () => {
    ...
    describe('CashIssueMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CashIssueMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/cash-issues';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CashIssueMySuffix', () => {
