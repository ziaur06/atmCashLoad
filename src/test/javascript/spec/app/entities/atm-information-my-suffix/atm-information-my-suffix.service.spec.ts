...
describe('Service Tests', () => {
    ...
    describe('AtmInformationMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AtmInformationMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/atm-informations';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return AtmInformationMySuffix', () => {
