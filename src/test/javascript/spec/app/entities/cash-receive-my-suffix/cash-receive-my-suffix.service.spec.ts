...
describe('Service Tests', () => {
    ...
    describe('CashReceiveMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CashReceiveMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/cash-receives';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CashReceiveMySuffix', () => {
